...
<style>
    *, *::before, *::after { box-sizing: border-box; }
    ...
    .doc-title { text-align:center; font-size:14px; margin-bottom:2px; font-weight:600; }
    ...
    /* Add padding-left for name input to avoid overlap */
    .field-wrapper input[name="name"] {
        padding-left:28px;
    }
    ...
    <div class="login-card<?= $hasError ? ' has-error' : '' ?>">
        ...
        <form method="POST" action="login.php">
            ...
            <div class="field-wrapper email-wrapper">
                ...
                <svg class="email-icon" viewBox="0 0 16 16">
